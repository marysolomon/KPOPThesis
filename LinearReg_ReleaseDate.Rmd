...
$$
360 - \hat{months} = \frac{exp(2.837 + 0.003{duration} + 0.409{danceability} + 0.533{energy}+ 0.004{key4} + 0.092{key4} + 0.024{key6}+ 0.082{key9} + 0.099{key10} + 0.077{key11} + 0.001{tempo} + 0.321{valence})}{exp(0.022{popularity} + 0.240{acousticness} + 0.808{instrumentalness} + 0.027{key1} + 0.056{key7} + 0.068{key8}+ 0.084{loudness} + 0.280{speechiness})}
$$
