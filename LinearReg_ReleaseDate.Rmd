...
ggplot(data, aes(x=months)) +
  ...
  theme_bw()
ggsave("~/Desktop/KPOPThesis/Figures/Predicting Release Date/months_DensityPlot.png")
dev.off()
```


```{r}
png(filename = "~/Desktop/KPOPThesis/Figures/Predicting Release Date/months_normalQQ.png")
...
ggplot(data, aes(x=log(360-data$months))) +
  ...
  theme_bw()
ggsave("~/Desktop/KPOPThesis/Figures/Predicting Release Date/transform_months_DensityPlot.png")
dev.off()
```


```{r}
png(filename = "~/Desktop/KPOPThesis/Figures/Predicting Release Date/transform_months_normalQQ.png")
#produce normal qqplot to assess normality
...
```{r}
png(filename = "~/Desktop/KPOPThesis/Figures/Predicting Release Date/months_diagnostics_mode0.png")
par(mfrow = c(2,2))
plot(ml0)
dev.off()
```
...
```{r}
ml1 <- lm(months ~. , data = train1)
summary(ml1)
png(filename = "~/Desktop/KPOPThesis/Figures/Predicting Release Date/months_diagnostics_mode1.png")
par(mfrow = c(2,2))
plot(ml1)
dev.off()
```
...
```{r}
png(filename = "~/Desktop/KPOPThesis/Figures/Predicting Release Date/transform_months_diagnostics_mode0.png")
par(mfrow = c(2,2))
plot(mlr0)
dev.off()
```
...
$$
log(360 - \hat{months}) = 2.739 - 0.022{popularity} + 0.003{duration} - 0.240{acousticness} + 0.424{danceability} +  0.572{energy}
\\  - 0.848{instrumentalness} - 0.013{key1} + 0.016{key2} + 0.035{key3} + 0.118{key4} + 0.017{key5} 
\\ 
\\ + 0.051{key6} - 0.087{key7}  -0.056{key8} +  0.109{key9} + 0.126{key10} + 0.101{key11}
...
$$
log(360 - \hat{months}) = 2.732 - 0.022{popularity} + 0.003{duration} - 0.241{acousticness} + 0.425{danceability} +  0.572{energy} 
\\  
- 0.852{instrumentalness} + 0.125{key4} + 0.057{key6} +  0.115{key9} + 0.133{key10} + 0.107{key11 }
\\ 
...
$$
log(360 - \hat{months}) = 2.733 - 0.022{popularity} + 0.003{duration} - 0.241{acousticness} + 0.425{danceability} +  0.572{energy} 
\\  
- 0.852{instrumentalness} + 0.125{key4} + 0.057{key6}+  0.115{key9} + 0.133{key10} + 0.107{key11}
\\ 
 - 0.087{loudness} - 0.328{speechiness} + 0.001{tempo} + 0.324{valence}
...
$$
log(360 - \hat{months}) = 2.866 - 0.021{popularity} + 0.003{duration} - 0.245{acousticness} + 0.413{danceability} +  0.482{energy}
\\  - 0.749{instrumentalness} - 0.034{key1} - 0.006{key2} + 0.008{key3} + 0.095{key4} - 0.007{key5} 
\\ 
\\ + 0.023{key6} - 0.063{key7} - 0.075{key8} + 0.082{key9} + 0.099{key10} + 0.078{key11}
...
$$
log(360 - \hat{months}) = 2.838 - 0.021{popularity} + 0.003{duration} - 0.240{acousticness} + 0.409{danceability} + 0.528{energy}
\\ - 0.802{instrumentalness} - 0.027{key1} + 0.005{key3} + 0.093{key4} + 0.024{key6}
\\ - 0.056{key7} - 0.068{key8} + 0.083{key9} + 0.010{key10} + 0.078{key11}
\\ - 0.084{loudness} - 0.280{speechiness} + 0.001{tempo} + 0.322{valence}
$$
...
$$
log(360 - \hat{months}) = 2.837 - 0.022{popularity} + 0.003{duration} - 0.240{acousticness} 
...
$$
360 - \hat{months} = \frac{exp(2.837 + 0.003{duration} + 0.409{danceability} + 0.533{energy}+ 0.004{key3} + 0.092{key4} + 0.024{key6}+ 0.082{key9} + 0.099{key10} + 0.077{key11} + 0.001{tempo} + 0.321{valence})}{exp(0.022{popularity} + 0.240{acousticness} + 0.808{instrumentalness} + 0.027{key1} + 0.056{key7} + 0.068{key8}+ 0.084{loudness} + 0.280{speechiness})}
$$
...
assess model assumptions
```{r}
png(filename = "~/Desktop/KPOPThesis/Figures/Predicting Release Date/tranform_months_diagnostics_mode1.png")
par(mfrow = c(2,2))
plot(mlr1)
dev.off()
```
...
$$
log(360 - \hat{months}) = 2.990 - 0.020{popularity} + 0.002{duration} - 0.127{acousticness} + 0.631{danceability} +  0.383{energy}
\\  - 0.771{instrumentalness} + 0.084{key1} + 0.029{key2} + 0.020{key3} + 0.068{key4} + 0.075{key5} 
\\ + 0.096{key6} + 0.102{key7} + 0.119{key8} + 0.012{key9} + 0.081{key10} + 0.046{key11}
\\ 
...
$$
log(360 - \hat{months}) = 3.033 - 0.020{popularity} + 0.002{duration} - 0.122{acousticness} + 0.630{danceability} +  0.357{energy}
\\ - 0.768{instrumentalness} + 0.057{key1} + 0.048{key5} + 0.068{key6} + 0.074{key7}
\\  + 0.091{key8} - 0.074{loudness}   + 0.001{tempo} + 0.289{valence}
\\ 
$$
...
$$
log(360 - \hat{months}) = 3.143 - 0.019{popularity} + 0.002{duration} - 0.142{acousticness} + 0.597{danceability} +  0.279{energy} 
\\ - 0.690{instrumentalness} + 0.066{key1} + 0.012{key2} + 0.001{key3} + 0.050{key4} + 0.056{key5} 
\\ + 0.077{key6} + 0.081{key7} + 0.096{key8} - 0.005{key9} + 0.065{key10} + 0.028{key11}
...
$$
log(360 - \hat{months}) = 3.055 - 0.020{popularity} + 0.002{duration} - 0.127{acousticness}  + 0.622{danceability} +  0.354{energy} 
\\ 
- 0.750{instrumentalness} + 0.066{key1} + 0.010{key2} + 0.047{key4} + 0.055{key5}  
\\ + 0.077{key6} + 0.084{key7} + 0.0997{key8} + 0.061{key10} + 0.027{key11}
...
$$
log(360 - \hat{months}) = 3.101 - 0.020{popularity} + 0.002{duration} - 0.127s{acousticness}  + 0.615{danceability} +  0.334{energy} 
\\ 
- 0.734{instrumentalness} + 0.056{key1} + 0.035{key4} + 0.044{key5}  
\\ + 0.066{key6} + 0.073{key7} + 0.088{key8} - 0.005{key9} + 0.049{key10} + 0.016{key11}
\\ - 0.072{loudness} - 0.123{speechiness} + 0.001{tempo} + 0.291{valence}
$$
...
$$
360 - \hat{months} = \frac{exp(3 + 0.002{duration} + 0.630{danceability} +  0.357{energy} + 0.062{key1} + 0.053{key5} + 0.073{key6} + 0.079{key7} + 0.096{key8} + 0.060{key10} + 0.001{tempo} + 0.289{valence})}{exp(0.020{popularity} + 0.124{acousticness} + 0.765{instrumentalness} + 0.074{loudness} )}
$$
