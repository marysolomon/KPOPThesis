...
#get predicted probabilities for the test data
logit.test0.pred <- predict(logit0.final, newdata = test0, type = "response")
logit.test0.y <- ifelse(logit.test0.pred > 0.57, 1, 0) # using cutoff = 0.5
confusionMatrix(as.factor(logit.test0.y), as.factor(test0$oldgen), 
                positive = "1")
```
...
#get predicted probabilities for the test data
logit.test0.pred <- predict(logit0.final, newdata = test0, type = "response")
logit.test0.y <- ifelse(logit.test0.pred > 0.64, 1, 0) # using cutoff = 0.64
confusionMatrix(as.factor(logit.test0.y), as.factor(test0$oldgen), 
                positive = "1")
```
...
predict and evaluate on test using optimal cut off 0.55 for highest kappa
```{r}
#get predicted probabilities for the test data
step.test0.pred <- predict(step0.final, newdata = test0, type = "response")
step.test0.y <- ifelse(step.test0.pred > 0.55, 1, 0) # using cutoff = 0.55
confusionMatrix(as.factor(step.test0.y), as.factor(test0$oldgen), 
                positive = "1")
```
...
#get predicted probabilities for the test data
step.test0.pred <- predict(step0.final, newdata = test0, type = "response")
step.test0.y <- ifelse(step.test0.pred > 0.63, 1, 0) # using cutoff = 0.63
confusionMatrix(as.factor(step.test0.y), as.factor(test0$oldgen), 
                positive = "1")
```
...
Get prediction and performance evaluation for optimal cut off 0.58 for highest kappa
```{r}
#get predicted probabilities for the test data
step_kcv.test0.pred <- predict(step0_kcv.final, newdata = key.dummy(test0), type = "response")
step_kcv.test0.y <- ifelse(step_kcv.test0.pred > 0.58, 1, 0) # using cutoff = 0.58
confusionMatrix(as.factor(step_kcv.test0.y), as.factor(test0$oldgen), 
                positive = "1")
```

Get prediction and performance evaluation for optimal cut off 0.63 for best sensitivity/specificity balance
```{r}
#get predicted probabilities for the test data
step_kcv.test0.pred <- predict(step0_kcv.final, newdata = key.dummy(test0), type = "response")
step_kcv.test0.y <- ifelse(step_kcv.test0.pred > 0.63, 1, 0) # using cutoff = 0.63
confusionMatrix(as.factor(step_kcv.test0.y), as.factor(test0$oldgen), 
                positive = "1")
```
...
#get predicted probabilities for the test data
all.test0.pred <- predict(allreg.logit0.final, newdata = test0, type = "response")
all.test0.y <- ifelse(all.test0.pred > 0.55, 1, 0) # using cutoff = 0.55
confusionMatrix(as.factor(all.test0.y), as.factor(test0$oldgen), 
                positive = "1")
```
...
#get predicted probabilities for the test data
all.test0.pred <- predict(allreg.logit0.final, newdata = test0, type = "response")
all.test0.y <- ifelse(all.test0.pred > 0.63, 1, 0) # using cutoff = 0.63
confusionMatrix(as.factor(all.test0.y), as.factor(test0$oldgen), 
                positive = "1")
```
...
```{r}
prob.ridge0 <- predict(ridge0.final, s = ridge0.final$bestTune, test0, type = "prob")
pred.ridge0 <- ifelse(prob.ridge0[,2] > 0.56, 1, 0) # using cutoff = 0.56
confusionMatrix(as.factor(pred.ridge0), as.factor(test0$oldgen), 
                positive = "1")
```
...
```{r}
prob.ridge0 <- predict(ridge0.final, s = ridge0.final$bestTune, test0, type = "prob")
pred.ridge0 <- ifelse(prob.ridge0[,2] > 0.63, 1, 0) # using cutoff = 0.63
confusionMatrix(as.factor(pred.ridge0), as.factor(test0$oldgen), 
                positive = "1")
```
...
predict and evaluate on the test set where cutoff is at 0.63 corresponding to optimal balance of sensitivity and specificity
```{r}
prob.lasso0 <- predict(lasso0.final, s = lasso0.final$bestTune, test0, type = "prob")
pred.lasso0 <- ifelse(prob.lasso0[,2] > 0.63, 1, 0) # using cutoff = 0.63
confusionMatrix(as.factor(pred.lasso0), as.factor(test0$oldgen), 
                positive = "1")
```
...
```{r}
prob.enet0 <- predict(enet0.final, s = enet0.final$bestTune, test0, type = "prob")
pred.enet0 <- ifelse(prob.enet0[,2] > 0.59, 1, 0) # using cutoff = 0.59
confusionMatrix(as.factor(pred.enet0), as.factor(test0$oldgen), 
                positive = "1")
```
...
```{r}
prob.enet0 <- predict(enet0.final, s = enet0.final$bestTune, test0, type = "prob")
pred.enet0 <- ifelse(prob.enet0[,2] > 0.63, 1, 0) # using cutoff = 0.63
confusionMatrix(as.factor(pred.enet0), as.factor(test0$oldgen), 
                positive = "1")
```
...
#get predicted probabilities for the test data
logit.test1.pred <- predict(logit1.final, newdata = test1, type = "response")
logit.test1.y <- ifelse(logit.test1.pred > 0.65, 1, 0) # using cutoff = 0.65
confusionMatrix(as.factor(logit.test1.y), as.factor(test1$oldgen), 
                positive = "1")
```
...
predict and evaluate on test using optimal cut off 0.6 for highest kappa
```{r}
#get predicted probabilities for the test data
step.test1.pred <- predict(step1.final, newdata = test1, type = "response")
step.test1.y <- ifelse(step.test1.pred > 0.6, 1, 0) # using cutoff = 0.6
confusionMatrix(as.factor(step.test1.y), as.factor(test1$oldgen), 
                positive = "1")
```
...
#get predicted probabilities for the test data
step.test1.pred <- predict(step1.final, newdata = test1, type = "response")
step.test1.y <- ifelse(step.test1.pred > 0.64, 1, 0) # using cutoff = 0.64
confusionMatrix(as.factor(step.test1.y), as.factor(test1$oldgen), 
                positive = "1")
```
...
Get prediction and performance evaluation for optimal cut off 0.6 for highest kappa
```{r}
#get predicted probabilities for the test data
step_kcv.test1.pred <- predict(step1_kcv.final, newdata = key.dummy(test1), type = "response")
step_kcv.test1.y <- ifelse(step_kcv.test1.pred > 0.6, 1, 0) # using cutoff = 0.6
confusionMatrix(as.factor(step_kcv.test1.y), as.factor(test1$oldgen), 
                positive = "1")
```

Get prediction and performance evaluation for optimal cut off 0.64 for best sensitivity/specificity balance
```{r}
#get predicted probabilities for the test data
step_kcv.test1.pred <- predict(step1_kcv.final, newdata = key.dummy(test1), type = "response")
step_kcv.test1.y <- ifelse(step_kcv.test1.pred > 0.64, 1, 0) # using cutoff = 0.64
confusionMatrix(as.factor(step_kcv.test1.y), as.factor(test1$oldgen), 
                positive = "1")
```
...
#get predicted probabilities for the test data
all.test1.pred <- predict(allreg.logit1.final, newdata = test1, type = "response")
all.test1.y <- ifelse(all.test1.pred > 0.6, 1, 0) # using cutoff = 0.6
confusionMatrix(as.factor(all.test1.y), as.factor(test1$oldgen), 
                positive = "1")
```
...
#get predicted probabilities for the test data
all.test1.pred <- predict(allreg.logit1.final, newdata = test1, type = "response")
all.test1.y <- ifelse(all.test1.pred > 0.64, 1, 0) # using cutoff = 0.64
confusionMatrix(as.factor(all.test1.y), as.factor(test1$oldgen), 
                positive = "1")
```
...
predict and evaluate on the test set where cutoff is at 0.6 corresponding to optimal kappa
```{r}
prob.ridge1 <- predict(ridge1.final, s = ridge1.final$bestTune, test1, type = "prob")
pred.ridge1 <- ifelse(prob.ridge1[,2] > 0.6, 1, 0) # using cutoff = 0.6
confusionMatrix(as.factor(pred.ridge1), as.factor(test1$oldgen), 
                positive = "1")
```
...
```{r}
prob.ridge1 <- predict(ridge1.final, s = ridge1.final$bestTune, test1, type = "prob")
pred.ridge1 <- ifelse(prob.ridge1[,2] > 0.64, 1, 0) # using cutoff = 0.64
confusionMatrix(as.factor(pred.ridge1), as.factor(test1$oldgen), 
                positive = "1")
```
...
```{r}
prob.lasso1 <- predict(lasso1.final, s = lasso1.final$bestTune, test1, type = "prob")
pred.lasso1 <- ifelse(prob.lasso1[,2] > 0.6, 1, 0) # using cutoff = 0.6
confusionMatrix(as.factor(pred.lasso1), as.factor(test1$oldgen), 
                positive = "1")
```
...
```{r}
prob.lasso1 <- predict(lasso1.final, s = lasso1.final$bestTune, test1, type = "prob")
pred.lasso1 <- ifelse(prob.lasso1[,2] > 0.65, 1, 0) # using cutoff = 0.65
confusionMatrix(as.factor(pred.lasso1), as.factor(test1$oldgen), 
                positive = "1")
```
...
```{r}
prob.enet1 <- predict(enet1.final, s = enet1.final$bestTune, test1, type = "prob")
pred.enet1 <- ifelse(prob.enet1[,2] > 0.6, 1, 0) # using cutoff = 0.6
confusionMatrix(as.factor(pred.enet1), as.factor(test1$oldgen), 
                positive = "1")
```
...
```{r}
prob.enet1 <- predict(enet1.final, s = enet1.final$bestTune, test1, type = "prob")
pred.enet1 <- ifelse(prob.enet1[,2] > 0.64, 1, 0) # using cutoff = 0.64
confusionMatrix(as.factor(pred.enet1), as.factor(test1$oldgen), 
                positive = "1")
```
